...
<body>
    ...
    <h1><span>AULA PHP</span><br>Validação de Formulário</h1>
     ...
     <form method="post">
        ...
        <input type="password" <?php if(!empty($erroSenha)){echo "class='invalido'";}?> <?php if (isset($_POST['repete_senha'])){ echo "value='".$_POST['repete_senha']."'";} ?> name="repete_senha" placeholder="Repita a senha">
